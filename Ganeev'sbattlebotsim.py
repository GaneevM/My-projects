...
# --- Enhanced Part Data with Descriptions ---
HEADS = {
...
def draw_mech_part(screen, x, y, p_type, p_name, scale=1.0, angle=0, flip=False):
    ...
    if p_type == "head":
        ...
        if d["shape"] == "dome":
            ...
            # Funny Face: Determined
            pygame.draw.circle(surface, WHITE, (cx-10, cy-5), 6) # Left Eye
            pygame.draw.circle(surface, WHITE, (cx+10, cy-5), 6) # Right Eye
            pygame.draw.circle(surface, BLACK, (cx-10, cy-5), 2)
            pygame.draw.circle(surface, BLACK, (cx+10, cy-5), 2)
            pygame.draw.line(surface, BLACK, (cx-10, cy+15), (cx+10, cy+15), 3) # Flat mouth
        elif d["shape"] == "cube":
            pygame.draw.rect(surface, main_c, (cx-30, cy-30, 60, 60), 0, 5)
            # Funny Face: Grumpy
            pygame.draw.line(surface, BLACK, (cx-15, cy-15), (cx-5, cy-10), 3) # Eyebrow L
            pygame.draw.line(surface, BLACK, (cx+15, cy-15), (cx+5, cy-10), 3) # Eyebrow R
            pygame.draw.rect(surface, (255, 50, 50), (cx-12, cy+10, 24, 4)) # Frown
        elif d["shape"] == "spike":
            pygame.draw.polygon(surface, main_c, [(cx, cy-45), (cx-30, cy+20), (cx+30, cy+20)])
            # Funny Face: Crazy
            pygame.draw.circle(surface, WHITE, (cx-8, cy-5), 10)
            pygame.draw.circle(surface, WHITE, (cx+8, cy-5), 5) # Smaller eye
            pygame.draw.circle(surface, BLACK, (cx-8, cy-5), 4)
            pygame.draw.circle(surface, BLACK, (cx+8, cy-5), 2)
            pygame.draw.arc(surface, BLACK, (cx-10, cy+2, 20, 15), 3.14, 0, 3) # Wavy mouth
